...
<body>
  ...
  <div class="display-event">
    ...
    <div class="gallery">
      <img src="pictures/birthday.jpg" alt="birthday">
      <img src="pictures/marriage.jpg" alt="marriage">
      <img src="pictures/babyshower.jpg" alt="babyshower">
      <img src="pictures/corportae.jpg" alt="corporate">
    </div>
  ...
  <div class="info">
    ...
    <div class="cards">
      <div class="card">
        <img src="pictures/userregister.png" alt="User Register Image"/>
        <p>Create account and connect with us.</p>
      </div>
      <div class="card">
        <img src="pictures/eventregister.jpg" alt="User Register Image"/>
        <p>Search, create and register many events.</p>
      </div>
      <div class="card">
        <img src="pictures/enjoy.jpg" alt="User Register Image"/>
